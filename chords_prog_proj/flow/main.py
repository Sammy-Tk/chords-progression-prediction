...
from chords_prog_proj.flow.flow import build_flow
flow = build_flow()
from chords_prog_proj.flow.parallelized_flow import build_parallel_flow
...
# In prod mode, `make run_workflow` only send a "snapshot" of your python code to Prefect (but does not executes it)
    ...
    flow.register("chords_progression_project")
